...
//        //float difficulty
    ...
    float straightTrackSpacingModifier = 4; //This is used to compensate for the fact that the spacing between the straight track points are too close as compared to the curved tracks, we need to modify them to compensate.
